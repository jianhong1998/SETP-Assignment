...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=designation" class="nav-item nav-designation"><span class='icon-field'><i class="fa fa-user-tie"></i></span> Designation List</a>
				...
				<a href="index.php?page=license" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-file-certificate"></i></span> License</a>
